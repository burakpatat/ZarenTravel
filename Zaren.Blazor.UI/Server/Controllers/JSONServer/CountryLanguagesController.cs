...
{
    [Route("odata/JSONServer/CountryLanguages")]
    public partial class CountryLanguagesController : ODataController
    {
        private ZarenUI.Server.Data.JSONServerContext context;

        public CountryLanguagesController(ZarenUI.Server.Data.JSONServerContext context)
        {
        ...
        public IEnumerable<ZarenUI.Server.Models.JSONServer.CountryLanguage> GetCountryLanguages()
        {
            var items = this.context.CountryLanguages.AsQueryable<ZarenUI.Server.Models.JSONServer.CountryLanguage>();
        ...
        partial void OnCountryLanguageGet(ref SingleResult<ZarenUI.Server.Models.JSONServer.CountryLanguage> item);

        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        [HttpGet("/odata/JSONServer/CountryLanguages(Id={Id})")]
        public SingleResult<ZarenUI.Server.Models.JSONServer.CountryLanguage> GetCountryLanguage(int key)
        {
        ...
        [HttpDelete("/odata/JSONServer/CountryLanguages(Id={Id})")]
        ...
        [HttpPut("/odata/JSONServer/CountryLanguages(Id={Id})")]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PutCountryLanguage(int key, [FromBody]ZarenUI.Server.Models.JSONServer.CountryLanguage item)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPatch("/odata/JSONServer/CountryLanguages(Id={Id})")]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PatchCountryLanguage(int key, [FromBody]Delta<ZarenUI.Server.Models.JSONServer.CountryLanguage> patch)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPost]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult Post([FromBody] ZarenUI.Server.Models.JSONServer.CountryLanguage item)
        {
            try
            {
                if(!ModelState.IsValid)
