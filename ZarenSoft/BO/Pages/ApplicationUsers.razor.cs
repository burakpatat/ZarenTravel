...
namespace Travel.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<Travel.Models.ApplicationUser> users;
        protected RadzenDataGrid<Travel.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(Travel.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(Travel.Models.ApplicationUser user)
        {
            try
            {
