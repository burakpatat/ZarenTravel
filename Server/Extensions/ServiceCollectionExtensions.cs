...
using WordyWellHero.Application.Interfaces.Services.Account;
using WordyWellHero.Application.Interfaces.Services.Identity;
using WordyWellHero.Application.Serialization.JsonConverters;
using WordyWellHero.Application.Serialization.Options;
using WordyWellHero.Application.Serialization.Serializers;
using WordyWellHero.Application.Serialization.Settings;
...
using WordyWellHero.Infrastructure.Services;
using WordyWellHero.Infrastructure.Services.Identity;
using WordyWellHero.Infrastructure.Shared.Services;
using WordyWellHero.Server.Localization;
using WordyWellHero.Server.Managers.Preferences;
using WordyWellHero.Server.Permission;
using WordyWellHero.Server.Services;
using WordyWellHero.Server.Settings;
...
namespace WordyWellHero.Server.Extensions
{
    internal static class ServiceCollectionExtensions
    {
        ...
        internal static IServiceCollection AddDatabase(
           ...
           IConfiguration configuration)
        {
            services.AddDbContext<WordyWellHudContext>(options => options
        ...
        internal static IServiceCollection AddIdentity(this IServiceCollection services)
        {
            services
                ...
                .AddEntityFrameworkStores<WordyWellHudContext>()
