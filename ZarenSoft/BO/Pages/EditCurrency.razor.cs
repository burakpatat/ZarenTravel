...
namespace Travel.Pages
{
    public partial class EditCurrency
    {
        ...
        {
            currency = await TravelCDbService.GetCurrencyById(Id);
        }
        protected bool errorVisible;
        protected Travel.Models.TravelCDb.Currency currency;

        protected async Task FormSubmit()
        {
            try
            {
                await TravelCDbService.UpdateCurrency(Id, currency);
