...
{
    [Route("odata/JSONServer/ProjectCategories")]
    public partial class ProjectCategoriesController : ODataController
    {
        private ZarenUI.Server.Data.JSONServerContext context;

        public ProjectCategoriesController(ZarenUI.Server.Data.JSONServerContext context)
        {
        ...
        public IEnumerable<ZarenUI.Server.Models.JSONServer.ProjectCategory> GetProjectCategories()
        {
            var items = this.context.ProjectCategories.AsQueryable<ZarenUI.Server.Models.JSONServer.ProjectCategory>();
        ...
        partial void OnProjectCategoryGet(ref SingleResult<ZarenUI.Server.Models.JSONServer.ProjectCategory> item);

        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        [HttpGet("/odata/JSONServer/ProjectCategories(Id={Id})")]
        public SingleResult<ZarenUI.Server.Models.JSONServer.ProjectCategory> GetProjectCategory(int key)
        {
        ...
        [HttpDelete("/odata/JSONServer/ProjectCategories(Id={Id})")]
        ...
        [HttpPut("/odata/JSONServer/ProjectCategories(Id={Id})")]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PutProjectCategory(int key, [FromBody]ZarenUI.Server.Models.JSONServer.ProjectCategory item)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPatch("/odata/JSONServer/ProjectCategories(Id={Id})")]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PatchProjectCategory(int key, [FromBody]Delta<ZarenUI.Server.Models.JSONServer.ProjectCategory> patch)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPost]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult Post([FromBody] ZarenUI.Server.Models.JSONServer.ProjectCategory item)
        {
            try
            {
                if(!ModelState.IsValid)
