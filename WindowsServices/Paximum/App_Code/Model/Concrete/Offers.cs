...
namespace Model.Concrete
{
    ...
    public class Offers : IEntity
    {
        ...
        private string _ExpresOn;
        [JsonPropertyName("expreson")]
        public string ExpresOn
        {
            get { return _ExpresOn; }
            set { _ExpresOn = value; }
        }
        ...
        private int? _GroupKeysId;
        [JsonPropertyName("groupkeysid")]
        public int? GroupKeysId
        {
            get { return _GroupKeysId; }
            set { _GroupKeysId = value; }
        }
