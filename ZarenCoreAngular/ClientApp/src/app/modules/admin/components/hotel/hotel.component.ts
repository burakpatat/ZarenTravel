...
export class HotelComponent implements OnInit, OnDestroy {
    ...
    getAllHotels() {
        this.hotelApiService.getAllHotels().subscribe(dtos => {
            this.dtos = dtos;
    ...
    deleteDialog(hotel: Hotel) {
        const dialogData = new ConfirmDialogModel("Really delete?", hotel.ıd.toString());
        ...
        dialogRef.afterClosed().subscribe(remove => {
            if (remove) {
                this.hotelApiService.deleteHotel(hotel.ıd).subscribe(() => {
                    this.getAllHotels();
