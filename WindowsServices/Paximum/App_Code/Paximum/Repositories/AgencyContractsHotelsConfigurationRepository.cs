...
public List<AgencyContractsHotelsConfiguration> DaysGetAll(){
            try
            {
                return connection.Query<AgencyContractsHotelsConfiguration>("AgencyContractsHotelsConfigurationDaysGetAll", commandType: CommandType.StoredProcedure).ToList();
...
public List<AgencyContractsHotelsConfiguration> DaysGetByFriday(bool Friday){
            try
            {
                return connection.Query<AgencyContractsHotelsConfiguration>("AgencyContractsHotelsConfigurationDaysGetByFriday", new
                {
Friday = Friday
...
public AgencyContractsHotelsConfiguration DaysGetByID(int Id){
            try
            {
                return connection.QueryFirstOrDefault<AgencyContractsHotelsConfiguration>("AgencyContractsHotelsConfigurationDaysGetByID", new
                {
Id = Id
...
public List<AgencyContractsHotelsConfiguration> DaysGetByMonday(bool Monday){
            try
            {
                return connection.Query<AgencyContractsHotelsConfiguration>("AgencyContractsHotelsConfigurationDaysGetByMonday", new
                {
Monday = Monday
                }, commandType: CommandType.StoredProcedure).ToList();
...
public List<AgencyContractsHotelsConfiguration> DaysGetBySaturday(bool Saturday){
            try
            {
                return connection.Query<AgencyContractsHotelsConfiguration>("AgencyContractsHotelsConfigurationDaysGetBySaturday", new
                {
Saturday = Saturday
                }, commandType: CommandType.StoredProcedure).ToList();
...
public List<AgencyContractsHotelsConfiguration> DaysGetBySunday(bool Sunday){
            try
            {
                return connection.Query<AgencyContractsHotelsConfiguration>("AgencyContractsHotelsConfigurationDaysGetBySunday", new
                {
Sunday = Sunday
                }, commandType: CommandType.StoredProcedure).ToList();
...
public List<AgencyContractsHotelsConfiguration> DaysGetByThursday(bool Thursday){
            try
            {
                return connection.Query<AgencyContractsHotelsConfiguration>("AgencyContractsHotelsConfigurationDaysGetByThursday", new
                {
Thursday = Thursday
                }, commandType: CommandType.StoredProcedure).ToList();
...
public List<AgencyContractsHotelsConfiguration> DaysGetByTuesday(bool Tuesday){
            try
            {
                return connection.Query<AgencyContractsHotelsConfiguration>("AgencyContractsHotelsConfigurationDaysGetByTuesday", new
                {
Tuesday = Tuesday
                }, commandType: CommandType.StoredProcedure).ToList();
...
public List<AgencyContractsHotelsConfiguration> DaysGetByWednesday(bool Wednesday){
            try
            {
                return connection.Query<AgencyContractsHotelsConfiguration>("AgencyContractsHotelsConfigurationDaysGetByWednesday", new
                {
Wednesday = Wednesday
                }, commandType: CommandType.StoredProcedure).ToList();
