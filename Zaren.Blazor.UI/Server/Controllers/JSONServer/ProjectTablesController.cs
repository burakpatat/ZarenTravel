...
{
    [Route("odata/JSONServer/ProjectTables")]
    public partial class ProjectTablesController : ODataController
    {
        private ZarenUI.Server.Data.JSONServerContext context;

        public ProjectTablesController(ZarenUI.Server.Data.JSONServerContext context)
        {
        ...
        public IEnumerable<ZarenUI.Server.Models.JSONServer.ProjectTable> GetProjectTables()
        {
            var items = this.context.ProjectTables.AsQueryable<ZarenUI.Server.Models.JSONServer.ProjectTable>();
        ...
        partial void OnProjectTableGet(ref SingleResult<ZarenUI.Server.Models.JSONServer.ProjectTable> item);

        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        [HttpGet("/odata/JSONServer/ProjectTables(Id={Id})")]
        public SingleResult<ZarenUI.Server.Models.JSONServer.ProjectTable> GetProjectTable(int key)
        {
        ...
        [HttpDelete("/odata/JSONServer/ProjectTables(Id={Id})")]
        ...
        [HttpPut("/odata/JSONServer/ProjectTables(Id={Id})")]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PutProjectTable(int key, [FromBody]ZarenUI.Server.Models.JSONServer.ProjectTable item)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPatch("/odata/JSONServer/ProjectTables(Id={Id})")]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PatchProjectTable(int key, [FromBody]Delta<ZarenUI.Server.Models.JSONServer.ProjectTable> patch)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPost]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult Post([FromBody] ZarenUI.Server.Models.JSONServer.ProjectTable item)
        {
            try
            {
                if(!ModelState.IsValid)
