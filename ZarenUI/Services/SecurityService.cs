...
namespace ZarenUI
{
    public partial class SecurityService
	{
        ...
        public SecurityService(NavigationManager navigationManager, IHttpClientFactory factory,SignInManager<ApplicationUser> signInManager, IHttpContextAccessor httpContextAccessor, IConfiguration configuration, IDistributedCache cache)
        {
            this.signInManager = signInManager;
            this.baseUri = new Uri($"{navigationManager.BaseUri}odata/Identity/");
            this.httpClient = factory.CreateClient("ZarenUI");
        ...
        {
            return _tokenHelper.GetUserByToken();
        }

        public bool IsAuthenticated()
        { 
			return _tokenHelper.GetUserByToken() != null;
        }
