...
// Reloads all scripts when navigating through pages
    function initComponents() {
        ...
        hoursRangeSliderInit()
        countChange()
        liveSearch()          
        languageSwitch()
        priceSwitch()
        meterRangeSliderInit()
        //
    ...
    function languageSwitch() {
        ...
        const mainFlag = document.querySelector('.js-language-mainFlag')
        ...
        items.forEach(el => {
            ...
            const flag = el.querySelector('.js-flag')
            ...
            el.addEventListener("click", () => {
                ...
                mainFlag.innerHTML = flag.innerHTML
            })
        ...
        `
          ...
          <button class="-link d-block col-12 text-left rounded-4 px-20 py-15 js-search-option">
            <div class="d-flex">
              ...
              <div class="ml-10">
                                 <div class="text-15 lh-12 fw-500 js-search-option-target">Sonuç Bulunamadı...</div>
              </div>
            </div>
          </button>
        `
    ...
    function hoursRangeSliderInit() {
        const targets = document.querySelectorAll('.js-hours-rangeSlider')
    ...
    function meterRangeSliderInit() {
        const targets = document.querySelectorAll('.js-meter-rangeSlider')
