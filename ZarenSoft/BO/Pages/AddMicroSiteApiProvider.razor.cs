...
{
    public partial class AddMicroSiteApiProvider
    {
        [Inject]
        ...
        {
            microSiteApiProvider = new Travel.Models.TravelCDb.MicroSiteApiProvider();
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await TravelCDbService.CreateMicroSiteApiProvider(microSiteApiProvider);
