...
{
    [Route("odata/JSONServer/Devices")]
    public partial class DevicesController : ODataController
    {
        private ZarenUI.Server.Data.JSONServerContext context;

        public DevicesController(ZarenUI.Server.Data.JSONServerContext context)
        {
        ...
        public IEnumerable<ZarenUI.Server.Models.JSONServer.Device> GetDevices()
        {
            var items = this.context.Devices.AsQueryable<ZarenUI.Server.Models.JSONServer.Device>();
        ...
        partial void OnDeviceGet(ref SingleResult<ZarenUI.Server.Models.JSONServer.Device> item);

        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        [HttpGet("/odata/JSONServer/Devices(Id={Id})")]
        public SingleResult<ZarenUI.Server.Models.JSONServer.Device> GetDevice(int key)
        {
        ...
        [HttpDelete("/odata/JSONServer/Devices(Id={Id})")]
        ...
        [HttpPut("/odata/JSONServer/Devices(Id={Id})")]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PutDevice(int key, [FromBody]ZarenUI.Server.Models.JSONServer.Device item)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPatch("/odata/JSONServer/Devices(Id={Id})")]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PatchDevice(int key, [FromBody]Delta<ZarenUI.Server.Models.JSONServer.Device> patch)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPost]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult Post([FromBody] ZarenUI.Server.Models.JSONServer.Device item)
        {
            try
            {
                if(!ModelState.IsValid)
