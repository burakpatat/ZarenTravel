...
using WordyWellHero.Infrastructure.Helpers;
...
using WordyWellHero.Shared.Constants.Role;
using WordyWellHero.Shared.Constants.User;

namespace WordyWellHero.Infrastructure
{
    public class DatabaseSeeder : IDatabaseSeeder
    {
        private readonly ILogger<DatabaseSeeder> _logger;
        private readonly IStringLocalizer<DatabaseSeeder> _localizer;
        private readonly WordyWellHudContext _db;
