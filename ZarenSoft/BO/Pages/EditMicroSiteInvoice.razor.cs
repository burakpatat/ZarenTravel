...
{
    public partial class EditMicroSiteInvoice
    {
        [Inject]
        ...
        {
            microSiteInvoice = await TravelCDbService.GetMicroSiteInvoiceById(Id);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await TravelCDbService.UpdateMicroSiteInvoice(Id, microSiteInvoice);
