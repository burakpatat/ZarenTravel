...
public List<AgencyContractsHotelInformation> ImageGetAll(){
            try
            {
                return connection.Query<AgencyContractsHotelInformation>("AgencyContractsHotelInformationImageGetAll", commandType: CommandType.StoredProcedure).ToList();
...
public AgencyContractsHotelInformation ImageGetByID(int Id){
            try
            {
                return connection.QueryFirstOrDefault<AgencyContractsHotelInformation>("AgencyContractsHotelInformationImageGetByID", new
                {
Id = Id
                }, commandType: CommandType.StoredProcedure);
...
public List<AgencyContractsHotelInformation> ImageGetByImagePath(string ImagePath){
            try
            {
                return connection.Query<AgencyContractsHotelInformation>("AgencyContractsHotelInformationImageGetByImagePath", new
                {
ImagePath = ImagePath
                }, commandType: CommandType.StoredProcedure).ToList();
...
public List<AgencyContractsHotelInformation> ImageGetByImageUrl(string ImageUrl){
            try
            {
                return connection.Query<AgencyContractsHotelInformation>("AgencyContractsHotelInformationImageGetByImageUrl", new
                {
ImageUrl = ImageUrl
                }, commandType: CommandType.StoredProcedure).ToList();
