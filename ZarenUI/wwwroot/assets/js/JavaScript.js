...
import { E as EventTracker, a as assertInstanceof, b as assert, h as hasKeyModifiers, i as isRTL, g as getDeepActiveElement, F as FocusOutlineManager, S as SaveRequestType, P as PromiseResolver, c as PluginController, d as PluginControllerEventType, r as record, U as UserAction, e as FittingType, f as PdfViewerBaseElement, s as shouldIgnoreKeyEvents, j as hasCtrlModifier, l as listenOnce, k as assertNotReached } from "./shared.rollup.js"; export { C as CrIconButtonElement, e as FittingType, G as GestureDetector, O as OpenPdfParamsParser, q as PAGE_SHADOW, f as PdfViewerBaseElement, c as PluginController, S as SaveRequestType, o as SwipeDetector, p as SwipeDirection, U as UserAction, V as Viewport, t as ViewportScroller, Z as ZoomManager, r as record, m as recordFitTo, n as resetForTesting, s as shouldIgnoreKeyEvents } from "./shared.rollup.js"; import { html, PolymerElement, FlattenedNodesObserver, Polymer } from "chrome://resources/polymer/v3_0/polymer/polymer_bundled.min.js"; export { BrowserApi, ZoomBehavior } from "./browser_api.js"; import { loadTimeData } from "chrome://resources/js/load_time_data.js"; import { LoadState, deserializeKeyEvent } from "./pdf_scripting_api.js";
// Copyright 2014 The Chromium Authors
...
`.content); styleMod$2.register("pdf-shared"); function getTemplate$b() {
...
class ViewerDocumentOutlineElement extends PolymerElement { static get is() { return "viewer-document-outline" } static get template() { return getTemplate$a() } static get properties() { return { bookmarks: Array } } } customElements.define(ViewerDocumentOutlineElement.is, ViewerDocumentOutlineElement); function getTemplate$9() {
...
`; document.head.appendChild(template.content); function getTemplate$8() {
...
`.content); styleMod.register("cr-input-style"); function getTemplate$7() {
...
<div id="icons" hidden$="[[!bookmarks.length]]" role="tablist">
  <div class$="
    ...
    <cr-icon-button iron-icon="pdf:thumbnails" role="tab" title="Küçük resimler" aria-label="Küçük resimler" aria-selected$="[[getAriaSelectedThumbnails_(thumbnailView_)]]" on-click="onThumbnailClick_" tabindex$="[[getTabIndexThumbnail_(thumbnailView_)]]">
    </cr-icon-button>
  </div>
  <div class$="
      button-wrapper cr-vertical-tab [[outlineButtonClass_(thumbnailView_)]]">
    <cr-icon-button iron-icon="pdf:doc-outline" role="tab" title="Dokümanın ana hatları" aria-label="Dokümanın ana hatları" aria-selected$="[[getAriaSelectedOutline_(thumbnailView_)]]" on-click="onOutlineClick_" tabindex$="[[getTabIndexOutline_(thumbnailView_)]]">
    </cr-icon-button>
  </div>
</div>
<div id="content">
...
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
class LocalStorageProxyImpl { getItem(key) { return window.localStorage.getItem(key) } setItem(key, value) { window.localStorage.setItem(key, value) } static getInstance() { return instance || (instance = new LocalStorageProxyImpl) } } let instance = null; function getTemplate() {
