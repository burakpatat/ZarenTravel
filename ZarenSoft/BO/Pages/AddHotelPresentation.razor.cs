...
{
    public partial class AddHotelPresentation
    {
        [Inject]
        ...
        {
            hotelPresentation = new Travel.Models.TravelCDb.HotelPresentation();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await TravelCDbService.CreateHotelPresentation(hotelPresentation);
