...
namespace ZarenUI.Server.Controllers.Connector
{
    ...
    public partial class DeviceGroupsController : ODataController
    {
        ...
        public IEnumerable<ZarenUI.Server.Models.Connector.DeviceGroup> GetDeviceGroups()
        {
            var items = this.context.DeviceGroups.AsQueryable<ZarenUI.Server.Models.Connector.DeviceGroup>();
        ...
        partial void OnDeviceGroupGet(ref SingleResult<ZarenUI.Server.Models.Connector.DeviceGroup> item);

        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        [HttpGet("/odata/Connector/DeviceGroups(Id={Id})")]
        public SingleResult<ZarenUI.Server.Models.Connector.DeviceGroup> GetDeviceGroup(int key)
        {
        ...
        [HttpDelete("/odata/Connector/DeviceGroups(Id={Id})")]
        ...
        [HttpPut("/odata/Connector/DeviceGroups(Id={Id})")]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PutDeviceGroup(int key, [FromBody]ZarenUI.Server.Models.Connector.DeviceGroup item)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPatch("/odata/Connector/DeviceGroups(Id={Id})")]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult PatchDeviceGroup(int key, [FromBody]Delta<ZarenUI.Server.Models.Connector.DeviceGroup> patch)
        {
            try
            {
                if(!ModelState.IsValid)
        ...
        [HttpPost]
        [EnableQuery(MaxExpansionDepth=10,MaxAnyAllExpressionDepth=10,MaxNodeCount=1000)]
        public IActionResult Post([FromBody] ZarenUI.Server.Models.Connector.DeviceGroup item)
        {
            try
            {
                if(!ModelState.IsValid)
