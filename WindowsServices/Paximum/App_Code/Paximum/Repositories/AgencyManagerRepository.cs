...
public List<AgencyManager> GetByAgencyId(int AgencyId){
            try
            {
                return connection.Query<AgencyManager>("AgencyManagerGetByAgencyId", new
                {
AgencyId = AgencyId
...
public List<AgencyManager> GetByAgencyUserId(int AgencyUserId){
            try
            {
                return connection.Query<AgencyManager>("AgencyManagerGetByAgencyUserId", new
                {
